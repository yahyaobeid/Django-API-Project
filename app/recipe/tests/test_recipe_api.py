...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Title sample number 2')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='TITLE NUMBER ONE')
        r2 = create_recipe(user=self.user, title='TITLE NUMBER TWO')
